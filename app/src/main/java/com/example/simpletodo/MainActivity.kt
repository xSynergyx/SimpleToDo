...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set up the button and input field, so that the user can enter a tak and add it to the list
        ...
        findViewById<Button>(R.id.add_button).setOnClickListener{
            ...
            // 1. Grab the text the user has input into the @id/add_task_field
